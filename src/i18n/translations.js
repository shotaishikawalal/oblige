  ...
  ja: {
    ...
    philosophy: {
      ...
      loop: {
        ...
        sub: "Commitment",
        desc: "最後まで責任を持ち、\n信頼に応え続ける",
        detail: "obligeの語源は「義務を負う」。プロジェクトの完了は、私たちにとってゴールではなくスタート。オープン後のフォローアップ、運営改善の提案、SNS運用のサポートまで、責任を持って伴走し続ける。その姿勢が、次のご依頼につながっている。",
      },
      tagline: "的を、決める。夜を、動かす。",
      taglineSub: "obligeとは「義務を負う」「恩恵を施す」「人の喜ぶことをする」。\nナイトタイムエコノミーに特化した総合プロデュース。",
    },
    ...
    divisions: {
      construction: {
        ...
        description: "営業時間が始まる瞬間から逆算する建築・施工。許認可対応から工程管理まで、狙った品質をミリ単位でつくり込みます。",
        strengths: [
          { title: "許認可対応", desc: "深夜営業に必要な各種許認可・届出をワンストップで対応" },
      ...
      "real-estate": {
        ...
        faq: [
          { q: "対応エリアはどこですか?", a: "全国対応しております。ナイトタイム業態に適した物件をリサーチいたします。" },
          { q: "民泊の運用代行もしていますか?", a: "企画・リノベーションから運用サポートまで対応しております。" },
      ...
      "interior-design": {
        ...
        process: [
          ...
          { step: "04", title: "施工", desc: "代表が現場に常駐し、品質を管理" },
      ...
      marketing: {
        ...
        faq: [
          { q: "SNS運用だけの依頼もできますか?", a: "はい、SNS運用のみのプランもご用意しております。" },
          { q: "どのSNSに対応していますか?", a: "Instagram・TikTok・X(Twitter)・LINE公式アカウントなど幅広く対応しております。" },
          { q: "AIを使った集客・運用支援もできますか?", a: "はい、LINE公式のAIチャットボット構築、キャスト動画のAI編集、AI画像生成、Google・食べログのレビュー自動返信など、ナイトタイム特化のAI運用パッケージをご用意しております。" },
      ...
      branding: {
        ...
        faq: [
          ...
          { q: "既存ブランドのリブランディングもできますか?", a: "はい、現状分析から新たなブランド戦略の策定まで対応しております。" },
      ...
      items: [
        {
          num: "01",
          title: "一本の矢で、6方向に当てる",
          desc: "建設・不動産・インテリア設計・飲食・マーケティング・ブランディングの6事業が連携。企画段階から運営まで一貫して見立てます。",
        },
        {
          num: "02",
          title: "夜の癖を、深く見立てる",
    ...
    company: {
      ...
      rows: [
        ...
        ["事業内容", "建設 / 不動産 / インテリア設計 / 飲食 / SNS・WEB広告 / ブランディング"],
    ...
    about: {
      ...
      message: {
        ...
        paragraphs: [
          ...
          "「oblige」とは、義務を負う、恩恵を施す、人の喜ぶことをする。この言葉に込めた想いは、お客様への約束です。的を射る提案で期待を超え、最後まで責任を持って伴走する。その姿勢こそが、私たちの価値だと考えています。",
    ...
    contactPage: {
      ...
      errors: {
        tooFast: "送信が早すぎます。少し時間をおいて、もう一度お試しください。",
    ...
    privacy: {
      ...
      subtitle: "個人情報保護方針",
      intro: "株式会社オブライジ(以下「当社」)は、お客様の個人情報の保護を重要な責務と認識し、以下のとおりプライバシーポリシーを定め、個人情報の適切な管理・保護に努めてまいります。",
      contactTitle: "お問い合わせ窓口",
      contactBody: "株式会社オブライジ\n〒542-0081 大阪市中央区南船場4-13-12 南船場OMビル6階\nEmail: info@oblige.jp",
      policies: [
        {
          title: "個人情報の収集について",
    ...
    partnership: {
      ...
      description: "大阪の老舗青果店「大宝青果」のフレッシュなグリーンスムージーを、obligeのキッチンカーで2026年夏より展開予定。青果のプロが厳選した素材で、ナイトタイムシーンに新しい食体験を生み出し、夜の街に健やかな一杯をお届けします。",
      dataLabels: {
        location: "Location",
        type: "Type",
        release: "Release",
